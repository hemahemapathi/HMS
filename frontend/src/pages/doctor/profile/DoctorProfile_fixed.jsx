...
const DoctorProfile = () => {
  ...
  const getProfileImageUrl = (imageId) => {
    const imageMap = {
      'doctor-male-1': '👨‍⚕️', // Professional Male Doctor
      'doctor-female-1': '👩‍⚕️', // Professional Female Doctor  
      'doctor-male-2': '👨‍⚕️', // Senior Male Doctor (same as male-1)
      'doctor-female-2': '👩‍💼', // Senior Female Doctor
      'doctor-neutral': '⚕️' // Medical Professional
    };
    return imageMap[imageId] || '👨‍⚕️';
  };
                    ...
                    <tbody>
                      ...
                      {['Saturday', 'Sunday'].map((day) => (
                        <tr key={day}>
                          ...
                          <td>-</td>
                          <td>-</td>
                          <td><span className="badge bg-secondary">Unavailable</span></td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
